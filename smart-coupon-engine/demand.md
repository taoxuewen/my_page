...
## [D9] 创建智能营销引擎企划书静态展示页面　—　2026-06-07
- **原始诉求**：基于 `tracardi-growthbook-dify-智能营销引擎方案.md` 创建一个高级简洁的静态网页，用于向投资人和合伙人展示。要求排版高级简洁，配色清爽，优化商业模式、市场、行动方案等内容。
- **背景**：需要一个专业的企划书展示页面，向投资人和合伙人清晰展示项目价值、商业模式和发展路线。
- **讨论结论 / 实现**：
  - 创建独立的静态网页 `templates/plan-presentation.html`
  - 设计风格：高级简洁，清爽配色（蓝白灰为主），大留白，优雅排版
  - 页面结构：
    1. Hero 区：核心价值主张
    2. 产品定位：AI-Native 智能营销引擎
    3. 技术方案：三种方案对比（完整版/轻量版/极简版）
    4. 市场分析：痛点、目标客户、市场规模
    5. 商业模式：按效果分成定价策略
    6. 实施路线图：4个阶段
    7. 核心优势与差异化
    8. 团队需求与联系方式
- **影响范围**：新增 `templates/plan-presentation.html`、`static/css/plan-presentation.css`；更新 plan.md 新增里程碑。
- **状态**：开发中（2026-06-07）。

## [D8] 收费方式展示：强调双赢模式（免费试用 + 按节省比例分成）　—　2026-06-07
- **原始诉求**：向客户展示收费方式，强调不采用预付费和一次性收费，而是前期免费使用，收取帮用户节省的券成本的一定比例，达到双赢。页面风格简洁大气，有苹果网页展示风格。
- **背景**：商家对 SaaS 产品的预付费模式有顾虑，需要展示低风险的合作方式，建立信任。
- **讨论结论 / 实现**：
  - 新增「收费方式」区块，位于「成功案例」和「快速入门」之间
  - 核心信息：「零成本起步 · 按效果付费」
  - 分三个层级说明：
    1. **免费试用**：前 3 个月完全免费，无任何费用
    2. **按节省分成**：仅收取帮您节省的券成本的 20%（例：节省 10 万元，仅收取 2 万元）
    3. **无风险承诺**：若未节省成本，不收取任何费用
  - 设计风格：延续苹果风，使用大留白、简洁图标、渐变背景卡片，突出信任感和专业性
- **影响范围**：改 `templates/smart-coupon.html`、`static/css/smart-coupon.css`；plan.md 对客页面章节（5.12）。
- **状态**：开发中（2026-06-07）。
